...
export const getVector4IndexBasedComponentValue = (vector4, entity, index) => {
    switch (index) {
        case 0:
 ...
 */
export const compress = (value, numOfBitsToUse) => {
 ...
 */
export const expand = (compressedBinaryData, numOfBitsToUse) => {
