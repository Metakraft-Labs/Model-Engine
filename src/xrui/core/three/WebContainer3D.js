...
export class WebContainer3D extends Object3D {
    ...
    // _intersectionGetGroupOrder(i:Intersection) {
    ...
    _intersectionSort(a, b) {
        const aLayer = a.object.parent3D;
        const bLayer = b.object.parent3D;
    ...
    _updateInteractions() {
        ...
        for (const ray of this._interactionRays) {
            ...
            } else this.raycaster.ray.copy(ray);
            ...
            if (intersection) {
                const layer = intersection.object.parent3D;
