...
export const readTransform = (v, entity) => {
...
export const writeTransform = (v, entity) => {
    if (!hasComponent(entity, TransformComponent) || hasComponent(entity, RigidBodyComponent))
        return;
