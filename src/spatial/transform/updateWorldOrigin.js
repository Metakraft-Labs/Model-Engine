...
export const updateWorldOriginFromScenePlacement = () => {
    ...
    originTransform.matrix
        .compose(originTransform.position, originTransform.rotation, Vector3_One)
        .invert();
    originTransform.matrixWorld.copy(originTransform.matrix);
    originTransform.matrixWorld.decompose(
...
export const updateWorldOrigin = () => {
    if (ReferenceSpace.localFloor) {
        ...
        ReferenceSpace.origin = ReferenceSpace.localFloor.getOffsetReferenceSpace(
