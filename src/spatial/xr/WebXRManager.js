...
export function createWebXRManager(renderer) {
    ...
    scope.setSession = async function (session, framebufferScaleFactor = 1) {
        if (session !== null) {
            ...
            if (
                ...
                const layerInit = {
                    antialias:
                        session.renderState.layers === undefined ? attributes.antialias : true,
                ...
                const projectionlayerInit = {
                    ...
                    textureType: scope.isMultiview ? "texture-array" : "texture",
