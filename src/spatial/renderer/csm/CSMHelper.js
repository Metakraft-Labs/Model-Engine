...
export class CSMHelper {
    ...
    constructor() {
        ...
        setComponent(frustumLinesEntity, EntityTreeComponent, {
    ...
    update(csm) {
        ...
        const frustumLines = getComponent(this.frustumLinesEntity, GroupComponent)[0];
        ...
        while (cascadeLines.length < cascades) {
            ...
            setComponent(
                cascadeLinesEntity,
                NameComponent,
                "CSM cascade line " + cascadeLines.length,
            );
            ...
            setComponent(
                cascadePlanesEntity,
                NameComponent,
                "CSM cascade plane " + cascadeLines.length,
            );
            ...
            setComponent(shadowLinesEntity, EntityTreeComponent, {
                parentEntity: Engine.instance.originEntity,
            });
            setComponent(
                shadowLinesEntity,
                NameComponent,
                "CSM shadow line " + cascadeLines.length,
            );
        ...
        for (let i = 0; i < cascades; i++) {
            ...
            const cascadeLine = getComponent(cascadeLines[i], GroupComponent)[0];
            ...
            const shadowLine = getComponent(shadowLines[i], GroupComponent)[0];
