...
import { createEntity, getComponent, removeEntity, setComponent, UUIDComponent } from "../ecs";
...
export const initializeSpatialViewer = canvas => {
    const viewerEntity = createEntity();
    setComponent(viewerEntity, NameComponent, "viewer");
    setComponent(viewerEntity, UUIDComponent, "ee.viewer");
    ...
    if (canvas) {
        setComponent(viewerEntity, RendererComponent, {
            canvas,
            scenes: [originEntity, localFloorEntity, viewerEntity],
        });
...
export const initializeSpatialEngine = () => {
    ...
    setComponent(localFloorEntity, UUIDComponent, "ee.local-floor");
