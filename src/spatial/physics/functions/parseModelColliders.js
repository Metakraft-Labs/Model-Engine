...
export function applyTransformToMesh(entity, mesh) {
...
export function applyTransformToMeshWorld(entity, mesh) {
    const transform = getComponent(entity, TransformComponent);
    mesh.updateMatrixWorld(true);
...
export function getTransform(posM, queM, scaM, posE, queE, scaE) {
