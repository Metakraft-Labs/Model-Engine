...
const setDirty = entity => (TransformComponent.dirtyTransforms[entity] = true);

export const lerpTransformFromRigidbody = (entity, alpha) => {
    /*
...
export const copyTransformToRigidBody = entity => {
...
const copyTransformToCollider = entity => {
    const world = Physics.getWorld(entity);
    if (!world) return;
    computeTransformMatrix(entity);
    const rigidbodyEntity = getAncestorWithComponent(entity, RigidBodyComponent);
...
const filterAwakeCleanRigidbodies = entity => {
