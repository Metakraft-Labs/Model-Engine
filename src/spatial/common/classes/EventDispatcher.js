export class EventDispatcher {
     ...
     */
    addEventListener(eventName, listener, ...args) {
     ...
     */
    hasEventListener(eventName, listener, ...args) {
        return (
     ...
     * @param listener Callback for the specified event.
     */
    removeEventListener(eventName, listener, ...args) {
     ...
     * @param eventName Name of the event to remove.
     */
    removeAllListenersForEvent(eventName, deleteEvent, ...args) {
        if (deleteEvent) {
