 ...
 * @returns Interpolation between start and end.
 */
export const degreeLerp = (start, end, t) => {
    let result;
 ...
 * @returns Interpolation between start and end.
 */
export const radianLerp = (start, end, t) => {
    let result;
    const diff = end - start;
    if (diff < -PI) {
 ...
 * @returns Interpolation between start and end.
 */
export const quatSlerp = (qa, qb, t) => {
    // quaternion to return
    const qm = { x: 0, y: 0, z: 0, w: 1 };
 ...
 * @returns
 */
export function smootheLerpAlpha(smoothness, deltaSeconds) {
