...
import { ValueGeneratorJSONDefaults } from "../../../../engine/scene/components/ParticleSystemComponent";
...
export default function ValueGenerator({ scope, value, onChange }) {
    ...
    const onRemoveBezier = useCallback(element => {
        const bezierScope = scope;
