...
export default function ImagePreviewInput({ value, onRelease, label, previewOnly, ...rest }) {
    return (
        <ImageContainer>
            {label && (
                <div className="self-stretch text-[8px] font-normal leading-3 text-neutral-200">
                    {label}
                </div>
            )}
