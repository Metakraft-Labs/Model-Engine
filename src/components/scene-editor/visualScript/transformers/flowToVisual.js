...
export const flowToVisual = (nodes, edges, variables, specGenerator) => {
    const visualScript = { nodes: [], variables: variables, customEvents: [] };
    ...
    nodes.forEach(node => {
        ...
        Object.entries(node.data.configuration).forEach(([key, value]) => {
            ...
            visualNode.configuration[key] = value;
        });
