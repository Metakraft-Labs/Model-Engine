        ...
        <div className="flex items-center gap-1">
            <Tooltip title={t("editor:toolbar.placement.click")}>
                <Button
                    ...
                    variant={
                        editorHelperState.placementMode.value === PlacementMode.CLICK
                            ? "outline"
                            : "transparent"
                    }
                    className="px-0"
            ...
            <Tooltip title={t("editor:toolbar.placement.drag")}>
                <Button
                    ...
                    variant={
                        editorHelperState.placementMode.value === PlacementMode.DRAG
                            ? "outline"
                            : "transparent"
                    }
                    className="px-0"
            ...
            >
                <Button
                    ...
                    className={twMerge(
                        "px-0",
                        rendererState.physicsDebug.value &&
            ...
            >
                <Button
                    ...
                    onClick={() =>
                        rendererState.nodeHelperVisibility.set(
                            !rendererState.nodeHelperVisibility.value,
                        )
                    }
