...
const cleanupGizmo = gizmoObj => {
    for (const child of gizmoObj.children) {
    ...
    reactor: function (props) {
        ...
        useEffect(() => {
            ...
            for (const mode in TransformMode) {
                ...
                setComponent(gizmo[mode], EntityTreeComponent, {
                ...
                setComponent(helper[mode], EntityTreeComponent, {
                    parentEntity: Engine.instance.originEntity,
                });
                ...
                setComponent(picker[mode], EntityTreeComponent, {
                    parentEntity: Engine.instance.originEntity,
                });
