...
function CheckBoxParam({ label, state }) {
    return (
...
function TextParam({ label, state, parseFunction = value => value }) {
    return (
...
export default function GLTFTransformProperties({ transformParms, itemCount = 1 }) {
