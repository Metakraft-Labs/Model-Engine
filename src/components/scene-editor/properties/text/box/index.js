...
const PaddingNumericInput = ({ value, onChange, borderStyles }) => {
    return (
        <div className="flex h-8 items-center justify-between rounded bg-[#1A1A1A] p-2">
            ...
            />
            <Typography fontSize="xs" className="text-right text-[#444444]">
                {"rem"}
            </Typography>
        </div>
    );
...
export const TextBoxEditor = props => {
    ...
    return (
        ...
        >
            ...
            <InputGroup
                ...
                name="Font Stroke"
                label={t("editor:properties.textBox.lbl-fontStroke")}
            >
            ...
            <InputGroup
                ...
                label={t("editor:properties.textBox.lbl-backgroundColor")}
            >
                <ColorInput />
            </InputGroup>
