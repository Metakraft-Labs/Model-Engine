...
import { FontMaterialKind, TextComponent } from "../../../../engine/scene/components/TextComponent";
 ...
 */
const LineHeightNumericDefault = 1.2;
 ...
 */
export const TextNodeEditor = props => {
        ...
        >
                ...
                <div>
                    ...
                    <InputGroup name="TextAlign" label={t("editor:properties.text.textAlign")}>
                        <SelectInput
                            ...
                            onChange={value =>
                                commitProperty(TextComponent, "textAlign")(value.toString())
                            }
                        />
                    </InputGroup>
            ...
            <InputGroup name="OutlineGroup" label={t("editor:properties.text.outlineGroup")}>
                <div>
                    <InputGroup
                        name="OutlineColor"
                        label={t("editor:properties.text.outlineColor")}
                    >
                        <ColorInput
                    ...
                    <InputGroup
                        name="OutlineOffset"
                        label={t("editor:properties.text.outlineOffset")}
                    >
                        <Vector2Input
                ...
                <InputGroup name="AdvancedGroup" label={t("editor:properties.text.advancedGroup")}>
                    <div>
                        <InputGroup
                            ...
                            info={HoverInfo.TextOrientation}
                        >
                            <ControlledStringInput
                        ...
                        >
                            <BooleanInput
                                value={text.clipActive.value}
                                onChange={text.clipActive.set}
                            />
                        </InputGroup>
                        <InputGroup
