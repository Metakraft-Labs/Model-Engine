...
import { HemisphereLightComponent } from "../../../../../spatial/renderer/components/lights/HemisphereLightComponent";
 ...
 */
export const HemisphereLightNodeEditor = props => {
    ...
    return (
        ...
        >
            ...
            <InputGroup
                name="Ground Color"
                label={t("editor:properties.hemisphere.lbl-groundColor")}
            >
                <ColorInput
