...
export const AvatarArmsTwistCorrectionComponent = defineComponent({
    ...
    onSet: (entity, component, json) => {
        ...
        if (json.LeftHandBindRotationInv)
            component.LeftHandBindRotationInv.set(json.LeftHandBindRotationInv);
        if (json.LeftArmTwistAmount) component.LeftArmTwistAmount.set(json.LeftArmTwistAmount);
        if (json.RightHandBindRotationInv)
            component.RightHandBindRotationInv.set(json.RightHandBindRotationInv);
