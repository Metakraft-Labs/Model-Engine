 ...
 */
export function retargetSkeleton(targetSkeleton, sourceSkeleton) {
 ...
 * @param skeleton
 */
export function syncModelSkeletons(model, skeleton) {
    let meshes = [];
    model.traverse(obj => {
