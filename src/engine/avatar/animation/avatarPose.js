 ...
 * @returns
 */
export function isSkeletonInTPose(rig) {
 ...
 */
const conformArmToTpose = (coformingBoneReference, conformingBone, targetBone, side) => {
 ...
 * @param mesh
 */
export function applySkeletonPose(mesh) {
...
export function boneNormalTransform(mesh, index, target) {
