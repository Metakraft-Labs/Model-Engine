...
export class OffScreenIndicator {
    ...
    camera;
    inside;
    margin; // Input: A number between 0 to 1
    rotation;
    borderScale;
    _vec3;
    _position; // Used Vector4 because an odd behaviour in Vector3
    _vpSize;
    _halfVPSize;
    _halfBorderSize;
    _mat4;
    ...
    setViewportSize(width, height) {
        ...
        this._halfBorderSize
            .set(width - width * this.margin, height - height * this.margin)
            .multiplyScalar(0.5);
    }
}
