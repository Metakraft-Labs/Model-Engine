...
import { useResource } from "../../../../spatial/resources/resourceHooks";
...
export const SplineHelperComponent = defineComponent({
    ...
    reactor: function () {
        ...
        useEffect(() => {
            ...
            const line = new Line(lineGeometry.value, lineMaterial);
