...
import * as VolumetricNodes from "../../../../../engine/scene/components/VolumetricNodes";
import {
    getNodeDescriptions,
...
export const registerEngineProfile = registry => {
