...
import { endXRSession, requestXRSession } from "../../../../../../spatial/xr/XRSessionFunctions";
import {
    NodeCategory,
...
export const getAnimationPack = makeFunctionNodeDefinition({
    ...
    exec: ({ read, write }) => {
        const animationPack = read("animationName");
...
export const fadeMesh = makeFlowNodeDefinition({
    ...
    triggered: ({ read, commit }) => {
        ...
        const opacitySlider = { opacity: 1, _opacity: 1 };
