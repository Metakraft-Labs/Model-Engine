...
export class GLTFLightsExtension {
    ...
    _loadLight(lightIndex) {
        ...
        // here, because node-level parsing will only position if explicitly specified.
...
export class GLTFMaterialsClearcoatExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        const extension = materialDef.extensions[this.name]; // TODO type extensions
...
export class GLTFTextureBasisUExtension {
    ...
    if ( ! json.textures[textureIndex] && json.images[ textureIndex ]) {
      ...
      json.textures[textureIndex] = {
        ...
        const extension = textureDef.extensions[this.name]; // TODO type extensions
...
export class GLTFTextureWebPExtension {
    ...
    loadTexture(textureIndex) {
        ...
        const extension = textureDef.extensions[name]; // TODO type extensions
        // @ts-ignore -- TODO type extensions
...
export class GLTFMeshoptCompression {
    ...
    loadBufferView(index) {
        ...
        if (bufferView.extensions && bufferView.extensions[this.name]) {
            const extensionDef = bufferView.extensions[this.name]; // TODO type extensions
...
export class GLTFMeshGpuInstancing {
    ...
    createNodeMesh(nodeIndex) {
        ...
        const extensionDef = nodeDef.extensions[this.name]; // TODO type extensions
