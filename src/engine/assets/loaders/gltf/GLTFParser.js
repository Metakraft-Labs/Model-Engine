...
export class GLTFParser {
    ...
    loadMaterial(materialIndex) {
        ...
        let materialType;
        const materialParams = {}; // todo
        const materialExtensions = materialDef.extensions || {};

        const pending = []; // todo

        if (
            !materialExtensions[EXTENSIONS.EE_MATERIAL] &&
    ...
    loadCamera(cameraIndex) {
        ...
        const params = cameraDef[cameraDef.type]; // todo
    ...
    loadAnimation(animationIndex) {
        ...
        const pendingNodes = []; // todo
        const pendingInputAccessors = []; // todo
        const pendingOutputAccessors = []; // todo
        const pendingSamplers = []; // todo
        const pendingTargets = []; // todo
