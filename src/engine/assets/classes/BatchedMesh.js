...
class BatchedMesh extends Mesh {
    ...
    setMatrixAt(geometryId, matrix) {
        // @TODO geometryId to index of the arrays because
...
export function convertToBatchedMesh(meshes) {
    const numMeshes = meshes.length;
    const totalVertices = meshes
        .map(mesh => mesh.geometry.attributes["position"].count)
        .reduce((x, y) => x + y);
