import { Engine, getComponent, matchesEntityUUID, UUIDComponent } from "../../../ecs";
import { defineAction, dispatchAction, getState, matches } from "../../../hyperflux";
import {
...
export const grabEntity = (grabberEntity, grabbedEntity, attachmentPoint) => {
...
export const dropEntity = grabberEntity => {
