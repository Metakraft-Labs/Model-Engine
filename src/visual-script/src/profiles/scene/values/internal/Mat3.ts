...
export function mat3SetColumn3(m: Mat3, columnIndex, column: Vec3, result = new Mat3()): Mat3 {
...
export function mat3SetRow3(m: Mat3, rowIndex, row: Vec3, result = new Mat3()): Mat3 {
    const re = result.set(m.elements).elements;
...
export function mat3Equals(a: Mat3, b: Mat3, tolerance = EPSILON) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat3MultiplyByScalar(a: Mat3, b, result: Mat3 = new Mat3()): Mat3 {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat3Determinant(m: Mat3) {
    const me = m.elements;
...
export function mat3Mix(a: Mat3, b: Mat3, t, result = new Mat3()): Mat3 {
    const s = 1 - t;
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat3ToArray(a: Mat3, array: Float32Array | number[], offset = 0) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        array[offset + i] = a.elements[i];
    }
}

export function mat3ToString(a: Mat3) {
    return toSafeString(a.elements);
}
export function mat3Parse(text, result = new Mat3()): Mat3 {
