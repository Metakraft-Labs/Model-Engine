...
export function mat4SetColumn4(m: Mat4, columnIndex, column: Vec4, result = new Mat4()): Mat4 {
...
export function mat4SetRow4(m: Mat4, rowIndex, row: Vec4, result = new Mat4()): Mat4 {
    const re = result.set(m.elements).elements;
...
export function mat4Equals(a: Mat4, b: Mat4, tolerance = EPSILON) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat4MultiplyByScalar(a: Mat4, b, result: Mat4 = new Mat4()): Mat4 {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat4Determinant(m: Mat4) {
...
export function mat4Mix(a: Mat4, b: Mat4, t, result = new Mat4()): Mat4 {
    const s = 1 - t;
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat4ToArray(a: Mat4, array: Float32Array | number[], offset = 0) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        array[offset + i] = a.elements[i];
    }
}

export function mat4ToString(a: Mat4) {
    return toSafeString(a.elements);
}

export function mat4Parse(text, result = new Mat4()): Mat4 {
...
export function mat4Perspective(left, right, top, bottom, near, far, result = new Mat4()): Mat4 {
...
export function mat4Orthogonal(left, right, top, bottom, near, far, result = new Mat4()): Mat4 {
