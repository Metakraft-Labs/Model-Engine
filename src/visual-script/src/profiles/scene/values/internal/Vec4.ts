...
export function vec4Equals(a: Vec4, b: Vec4, tolerance = EPSILON) {
    return (
...
export function vec4MultiplyByScalar(a: Vec4, b, result = new Vec4()): Vec4 {
...
export function vec4Length(a: Vec4) {
...
export function vec4Mix(a: Vec4, b: Vec4, t, result = new Vec4()): Vec4 {
    const s = 1 - t;
...
export function vec4ToArray(a: Vec4, array: Float32Array | number[], offset = 0) {
    array[offset + 0] = a.x;
    array[offset + 1] = a.y;
    array[offset + 2] = a.z;
    array[offset + 3] = a.w;
}
export function vec4ToString(a: Vec4) {
    return toSafeString([a.x, a.y, a.z, a.w]);
}
export function vec4Parse(text, result = new Vec4()): Vec4 {
...
export function quatSlerp(a: Vec4, b: Vec4, t, result = new Vec4()): Vec4 {
...
// from gl-matrix
export function quatPow(a: Vec4, b, result = new Vec4()): Vec4 {
    const ln = quatLn(a);
...
export function angleAxisToQuat(angle, axis: Vec3, result = new Vec4()): Vec4 {
...
// from gl-matrix
export function quatToAngleAxis(q: Vec4, result = new Vec3()): [angle, axis: Vec3] {
